...
describe("@nuraview/permissions statement surface", () => {
  it("exposes NuraView's resource statements alongside better-auth defaults", () => {
...
describe("built-in role privileges", () => {
  ...
  it("owner has every NuraView resource action including workspace:delete", () => {
