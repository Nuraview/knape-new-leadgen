...
export class AuthService {
  ...
  /**
   * True when a pre-created NuraView API key is used instead of the interactive
  ...
  private log(msg: string): void {
    console.error(`[nuraview-mcp] ${msg}`);
  }
  ...
  async getAccessToken(): Promise<string> {
    // Non-interactive auth: a pre-created NuraView API key (NURAVIEW_API_KEY) is sent
