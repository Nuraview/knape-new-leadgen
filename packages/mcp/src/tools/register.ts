...
import { z } from "zod";
import type { NuraViewClient } from "../nuraview/client.js";
import { buildFullTaskUpdateBody } from "../nuraview/task-helpers.js";
...
export function registerTools(
  ...
  server.registerTool(
    ...
    {
      description:
        "Return the current NuraView session and user for the cached device token.",
