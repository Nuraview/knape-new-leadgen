    ...
    <>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-6">
          ...
          {/*
            2FA lives here rather than in a screen of its own: it is an account
            credential, next to the email and password it protects. VK asked
            for it on the owner account only, so it is opt-in per user and
            nothing here nags anyone else to enable it.
          */}
          <TwoFactorSetup enabled={Boolean(access?.twoFactorEnabled)} />
        </div>
      </div>
    </>
  );
