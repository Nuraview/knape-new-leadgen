...
import { GitBranch, Plug, Settings, Users } from "lucide-react";
...
function RouteComponent() {
  ...
  const menuItems = [
    ...
    {
      // Per-person access — who on the team may open this board. There used to
      // be a "Visibility" tab next to it that published the whole board to the
      // internet; boards are internal, so this is the only access control.
      title: "Access",
      icon: Users,
      segment: "access",
    },
