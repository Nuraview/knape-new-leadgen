          ...
          <SidebarMenuItem>
            <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
              ...
              >
                ...
                {/*
                  "Add workspace" removed. NuraView is a single-tenant instance
                  with exactly one workspace, provisioned by seed-instance.ts —
                  and better-auth makes whoever creates a workspace its OWNER,
                  which used to grant CRM access. A projects-only employee could
                  click this and read the entire lead pipeline. The server now
                  refuses (allowUserToCreateOrganization: false); this removes
                  the button that led there.
                */}
              </DropdownMenuContent>
            </DropdownMenu>
          </SidebarMenuItem>
