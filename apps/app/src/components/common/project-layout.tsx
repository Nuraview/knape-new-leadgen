      ...
      <Layout.Header className="h-11 border-border/80 px-2">
        <div className="flex w-full items-center justify-between gap-2">
          ...
          <div className="flex shrink-0 items-center gap-1.5">
            {/*
              Who can see this board, on the board. It was originally only in
              Settings → Projects → Access, which nobody found — and "who can
              read this client's work" should not need looking for. The faces
              answer the question without a click.
            */}
            <ProjectAccessButton projectId={projectId} />
            {headerActions}
          </div>
        </div>
      </Layout.Header>
