      ...
      <div className="group relative w-full rounded-xl border border-border/80 bg-card/60">
        ...
        <div className="pt-0.5">
          <CommentEditor
            ...
            className={
              isEditing
                ? "[&_.nuraview-comment-editor-content_.ProseMirror]:min-h-[3rem] [&_.nuraview-comment-editor-content_.ProseMirror]:max-h-none [&_.nuraview-comment-editor-content_.ProseMirror]:overflow-visible [&_.nuraview-comment-editor-content_.ProseMirror]:px-3 [&_.nuraview-comment-editor-content_.ProseMirror]:pt-2.5 [&_.nuraview-comment-editor-content_.ProseMirror]:pb-2"
                : "nuraview-comment-viewer [&_.nuraview-comment-editor-content_.ProseMirror]:px-3 [&_.nuraview-comment-editor-content_.ProseMirror]:pt-2 [&_.nuraview-comment-editor-content_.ProseMirror]:pb-3"
            }
            autoFocus={isEditing}
            readOnly={!isEditing}
