...
export function NavProjects() {
  ...
  // Employees work a board they were assigned; they do not spin up new ones.
  const isAdmin = access?.role === "owner" || access?.role === "admin";
  const canCreate = canCreateProjects() && isAdmin;
  ...
  // The project list, and the "Add project" button under it, are the PM
  // surface. A lead-gen account cannot open any of these boards — the API
  // refuses them — so the tree is hidden rather than shown as dead links.
