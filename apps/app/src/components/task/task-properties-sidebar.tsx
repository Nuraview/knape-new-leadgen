        ...
        {compact && (
          <div className="flex flex-row-reverse gap-2 w-full border-b border-border">
            <div className="flex px-3 py-2">
              ...
              {/* Link to this card, for the people assigned to the project.
                  Sits with the other card-level actions rather than in
                  Properties, because it acts on the card, not on a field. */}
              {taskId ? <TaskLinkPopover taskId={taskId} /> : null}
            </div>
