...
import { NuraViewIssueLink } from "./extensions/nuraview-issue-link";
import {
  ...
  return (
    ...
    >
      ...
      {editor && (
        <BubbleMenu
          editor={editor}
          className="nuraview-tiptap-bubble"
        ...
        >
          ...
          <Button
            ...
            variant="ghost"
            size="xs"
            className="nuraview-tiptap-bubble-btn"
            onClick={() =>
      ...
      {editor && (
        <BubbleMenu
          editor={editor}
          pluginKey="nuraview-table-bubble"
          className="nuraview-tiptap-bubble"
          shouldShow={({ editor: activeEditor, from, to }) =>
        ...
        >
          ...
          <Button
            ...
            variant="ghost"
            size="xs"
            className={cn("nuraview-tiptap-bubble-btn", "text-destructive")}
          ...
          {embedComposer.mode === "choice" ? (
            <div className="nuraview-embed-choice-menu">
              ...
              >
                ...
                <span className="nuraview-embed-choice-hint">Tab</span>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <span className="nuraview-embed-choice-hint">Esc</span>
              </button>
            </div>
          ) : (
            <form
      ...
      <EditorContent
        editor={editor}
        className="nuraview-tiptap-content"
