...
// it inserts a `nuraviewMention` node (which round-trips through Markdown). Built on
...
export const MentionSuggestion = Extension.create<MentionSuggestionOptions>({
  name: "nuraviewMentionSuggestion",
  ...
  addProseMirrorPlugins() {
    ...
    const suggestion: Omit<SuggestionOptions, "editor"> = {
      char: "@",
      pluginKey: new PluginKey("nuraviewMentionSuggestion"),
      allowSpaces: false,
      items: ({ query }) => {
      ...
      render: () => {
        ...
        return {
          onStart: (props) => {
            ...
            popup.className = "nuraview-mention-popup";
