...
import { crm_Opportunities } from "@/lib/db-types";
import {
  CalendarDays,
  ClipboardList,
  CoinsIcon,
...
import { saveGeneratedEmail } from "@/actions/crm/save-generated-email";
  ...
  return (
    <div className="pb-3 space-y-5">
      ...
      <GenerateEmailButton
        ...
        leadId={data.id}
        initialSubject={data.generatedEmailSubject}
        initialBody={data.generatedEmailBody}
        onSaveEmail={saveGeneratedEmail.bind(null, data.id)}
      />
    </div>
  );
}
