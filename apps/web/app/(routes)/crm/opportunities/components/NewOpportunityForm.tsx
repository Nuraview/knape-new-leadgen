...
export function NewOpportunityForm({
  ...
  const filteredContacts = useMemo(
    () =>
      contacts.filter(
        (contact) =>
          contact.last_name.toLowerCase().includes(searchContactValue.toLowerCase()) ||
          (contact.first_name &&
            contact.first_name.toLowerCase().includes(searchContactValue.toLowerCase())),
      ),
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='w-full h-full px-4 md:px-10'>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      placeholder='New NuraviewCRM functionality'
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem hidden={selectedStage ? true : false}>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={selectedStage}>
                        <FormControl>
                          <SelectTrigger>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent className='flex overflow-y-auto h-56'>
                          <Input
                            ...
                            onChange={(e) => setSearchAccountValue(e.target.value)}
                          />
        ...
        <div className='grid gap-2 py-5'>
          ...
          <Button
            disabled={form.formState.isSubmitting}
            type='submit'
            data-testid='opportunity-submit-btn'
          >
