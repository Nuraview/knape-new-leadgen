...
import { rescueCapEmbedFromBody } from "@/lib/videos/cap-link";
import { useRouter } from "next/navigation";
import type { Mail } from "@/app/(routes)/emails/data";
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Paste the share link (or embed code — we convert it). Sent as a
              clickable animated preview in the email.
            </p>
          </div>
          <div className="space-y-1">
            <Label>Message</Label>
            <Textarea
              value={body}
              onChange={(e) => {
                // Pasted Cap iframe embed code never renders in email —
                // convert it into the video-link field on the spot.
                const rescued = rescueCapEmbedFromBody(e.target.value);
                if (rescued) {
