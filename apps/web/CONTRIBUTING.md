# Contributing to NuraviewCRM

First off, thank you for considering contributing to NuraviewCRM! It's people like you that make NuraviewCRM a great tool for the community.

This document provides guidelines and instructions for contributing to the NuraviewCRM project.
...
NuraviewCRM supports multiple languages (English, Czech, German, Ukrainian):
...
Contributors will be recognized in our README and release notes. Thank you for helping make NuraviewCRM better!

---

By contributing to NuraviewCRM, you agree that your contributions will be licensed under the [MIT License](LICENSE.md).
