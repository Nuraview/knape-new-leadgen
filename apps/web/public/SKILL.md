---
name: nextcrm
description: Connect to NuraviewCRM MCP server to manage CRM data — accounts, contacts, leads, opportunities, targets, products, contracts, activities, documents, target lists, enrichment, email accounts, campaigns, projects, and reports.
---

# NuraviewCRM MCP Server Skill

Use the NuraviewCRM MCP server to read and write CRM data. This skill documents all available tools and how to use them.
...
- Replace `YOUR_NEXTCRM_URL` with your NuraviewCRM instance URL
