...
--> statement-breakpoint
ALTER TABLE "crm_Leads" ADD COLUMN "sent_email_subject" text;--> statement-breakpoint
ALTER TABLE "crm_Leads" ADD COLUMN "sent_email_body" text;--> statement-breakpoint
ALTER TABLE "crm_Leads" ADD COLUMN "sent_email_to" text;--> statement-breakpoint
ALTER TABLE "crm_Leads" ADD COLUMN "sent_email_cc" text;--> statement-breakpoint
