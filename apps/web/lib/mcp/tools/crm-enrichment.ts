...
export const crmEnrichmentTools = [
  {
    ...
    async handler(
      ...
      const contact = await orm.crm_Contacts.findUnique({
      ...
      const enrichment = await orm.crm_Contact_Enrichment.create({
        data: {
  ...
  },
  {
    ...
    async handler(
      ...
      const target = await orm.crm_Targets.findUnique({
      ...
      const enrichment = await orm.crm_Target_Enrichment.create({
        data: {
