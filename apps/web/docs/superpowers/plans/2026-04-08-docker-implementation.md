...
**Goal:** Enable users to run `docker-compose up` and get a fully working NuraviewCRM instance with app, Postgres, Inngest, and MinIO.
...
echo "==> NuraviewCRM Docker Entrypoint"
...
```bash
git add Dockerfile
git commit -m "feat: add multi-stage Dockerfile for NuraviewCRM"
```
...
services:
  ...
  app:
    ...
    environment:
      ...
      INNGEST_DEV: '1'
      INNGEST_ID: nextcrm
      INNGEST_APP_NAME: NuraviewCRM
      INNGEST_EVENT_KEY: local
      INNGEST_SIGNING_KEY: ''
      INNGEST_BASE_URL: http://inngest:8288

      # App
      NEXT_PUBLIC_APP_NAME: NuraviewCRM
...
```bash
# ===========================================
# NuraviewCRM Docker Environment Configuration
# ===========================================
