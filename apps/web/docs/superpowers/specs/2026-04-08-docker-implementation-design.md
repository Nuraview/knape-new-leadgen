...
Enable users to clone the NuraviewCRM repo and run `docker-compose up` to get a fully working instance — app, database, background jobs, and file storage — with zero manual configuration. Optimized for self-hosting platforms like Coolify.
...
| -------- | ------------------------- | ------------- | ------------ | ------------------------------ |
| app      | Built from `./Dockerfile` | 3000          | 3000         | NuraviewCRM application        |
...
| File                   | Purpose                                                      |
| ---------------------- | ------------------------------------------------------------ |
| `Dockerfile`           | Multi-stage build for NuraviewCRM                            |
