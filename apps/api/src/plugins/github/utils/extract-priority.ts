 ...
 * Returns null if no valid priority label found (lets NuraView use its defaults).
 */
 ...
 * Returns null if no valid status label found (lets NuraView use its defaults).
 */
