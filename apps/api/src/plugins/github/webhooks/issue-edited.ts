    ...
    if (changes.title) {
      ...
      if (lastTitleSync) {
        if (
          ...
          lastTitleSync.source === "nuraview"
        ) {
          console.log("Skipping title update - already synced from NuraView");
    ...
    if (changes.body) {
      ...
      if (lastDescSync) {
        if (
          ...
          lastDescSync.source === "nuraview"
        ) {
          console.log(
            "Skipping description update - already synced from NuraView",
          );
